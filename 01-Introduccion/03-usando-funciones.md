...
Los números del Día Juliano (a veces denotados con la unidad "jd") no deben ser 
...
En otras palabras, si `main` pasa `y` a `JulianToDate` -que lo asigna a su argumento de función `year`- 
